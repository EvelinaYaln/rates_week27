    ...
    <div id="cardContainer">    
      <div className="card" onClick = {handleChange}>
        <div className= {"color "+((props.color==="black") && "black" || (props.color==="red") && "red" || (props.color==="green") && "green" || (props.color==="blue") && "blue")}>
            <h2 className ={"heading " +(pressed ? "selected":"")}>Безлимитный {props.heading}</h2>
        ...
        <div className = {"content-rates "+(pressed ? "selected":"")}>Объем включенного трафика не ограничен</div>
      </div>
    </div>
    );
  }
